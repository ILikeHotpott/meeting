...
class ChatRoomBoxBiz {
    ...
    static setRoomName(roomName) {
        this.chatRoomNameEl.innerText = 'Room Title：' + roomName;
    }
    ...
    static listerClickCloseEvent() {
        this.exitChatRoomEl.addEventListener('click', () => {
            ConfirmTipsBoxControl.open("Exit the chat room now?", () => this.closeCallBackFun());
        });
    }
    ...
    static listerPublicBtnClick() {
        this.chatMessageLeftBtn.addEventListener('click', () => {
            ...
            this.hidePublicDot();
            CustomBoxControl.open("Public Chat Message", this.publicChatMessage.getChatMessageBoxEl(), () => this.publicFlag = false);
        });
    }
    static listerPrivateBtnClick() {
        this.chatMessageRightBtn.addEventListener('click', () => {
            ...
            this.hidePrivateDot();
            UserListTipsControl.open("User List", UserListControl.getUserListBox(), () => this.privateFlag = false);
        });
    }
